...
<head>
	...
	<link rel="stylesheet" href="{{asset('user/css/slider-radio.css')}}">
	...
	<!-- Favicons -->
	<link rel="icon" type="image/png" href="{{asset('user/icon/favicon-32x32.png')}}}}" sizes="32x32">
				...
				<div class="col-12">
					<div class="header__content">
						...
						<a href="/" class="header__logo">
							<img src="{{asset('/user/img/logo.svg')}}" alt="Movies & TV Shows, Online cinema HTML Template">
						</a>
						...
						<ul class="header__nav">
							...
							<li class="header__nav-item">
								...
								<ul class="dropdown-menu header__nav-menu header__nav-menu--scroll" aria-labelledby="dropdownMenu3">
									...
									<li><a href="../admin//" target="_blank">Admin pages</a></li>
							...
							<table class="plans__table">
								...
								<tbody>
									...
									<tr>
										<td></td>
										<td>
                                            <a class="plans__btn" href="{{ route('payment-method', 'price_1PWhkhRsway4zlmUJUYPsdck') }}">
                                                Select plan
                                            </a>
										</td>
										<td>
											<a class="plans__btn" href="{{ route('payment-method','price_1PWhmTRsway4zlmUNg00KkOU') }}">
                                                Select plan
                                            </a>
										</td>
										<td>
											<a class="plans__btn" href="{{ route('payment-method','price_1PWhn8Rsway4zlmUEa4UWwnJ') }}">
                                                Select plan
                                            </a>
										</td>
									</tr>
